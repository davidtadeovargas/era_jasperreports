...
public class RemReportModel extends BaseReport {
    ...
    public String getImplet() {
        return implet;
    }

    public void setImplet(String implet) {
        this.implet = implet;
    }
    ...
    public String getMetopag() {
        return metopag;
    }

    public void setMetopag(String metopag) {
    ...
    public String getDoment() {
        return doment;
    }

    public void setDoment(String doment) {
        this.doment = doment;
    }
